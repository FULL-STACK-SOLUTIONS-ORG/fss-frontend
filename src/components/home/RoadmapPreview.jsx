...
const RoadmapPreview = () => {
  ...
  return (
    <section id="roadmap-preview" className="py-20 px-4 sm:px-6 lg:px-8 relative" style={{ backgroundColor: '#F5F0E8' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg max-w-2xl mx-auto mb-8" style={{ color: '#5A5550' }}>
            Master full-stack development through our comprehensive 26-module program
          </p>
          <Link
            to="/roadmap"
            className="shiny-button inline-block px-6 py-3 rounded-xl font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 mb-12">
          {previewModules.map((module, index) => (
            <div
              key={index}
              className="rounded-xl p-6 transition-all duration-300 transform hover:-translate-y-2 text-center"
              style={{
                backgroundColor: '#FAF7F2',
                border: '1px solid #E0D8CC',
                boxShadow: '0 2px 8px rgba(28,26,23,0.06)'
              }}
              onMouseEnter={e => e.currentTarget.style.boxShadow = '0 10px 24px rgba(28,26,23,0.12)'}
              onMouseLeave={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(28,26,23,0.06)'}
            >
              <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3" style={{ backgroundColor: '#F5F0E8', border: '2px solid #E0D8CC' }}>
                {module.icon}
              </div>
              <h3 className="font-bold text-sm" style={{ color: '#1C1A17' }}>
                {module.name}
              </h3>
            </div>
          ))}
        </div>
        <div className="rounded-2xl p-8 md:p-12 text-center" style={{ backgroundColor: '#FAF7F2', border: '1px solid #D4B896' }}>
          <h3 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: '#1C1A17', fontFamily: "'Playfair Display', Georgia, serif" }}>
            Ready to Start Learning?
          </h3>
          <p className="text-lg mb-6 max-w-2xl mx-auto" style={{ color: '#5A5550' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              to="/roadmap"
              className="inline-block px-8 py-4 rounded-xl text-lg font-semibold transform hover:scale-105 transition-all duration-300"
              style={{ color: '#1C1A17', border: '1.5px solid #9B7D43', backgroundColor: 'transparent' }}
